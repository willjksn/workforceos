...
async function seedRequirementsAndDecisions(db: ReturnType<typeof getDb>) {
  ...
  const decisions = [
    ...
    ["DEC-MIL-005", "PierOne is the military-talent intermediary", "SkillBridge is a pathway/opportunity type, not a PierOne-owned SkillBridge program. Operator access bundle is Military Talent Partner. Physical tables are retained."],
