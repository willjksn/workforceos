...
describe("RBAC", () => {
  ...
  it("keeps AI cost consoles off Scout operators", () => {
    ...
    expect(can(talentPartner, "agents.read")).toBe(true);
    expect(can(talentPartner, "agents.manage")).toBe(false);
    expect(can(consultant, "agents.read")).toBe(true);
    expect(can(consultant, "scout.draft")).toBe(true);
    expect(can(consultant, "agents.manage")).toBe(false);
    expect(can(partner, "agents.read")).toBe(true);
    expect(can(partner, "agents.manage")).toBe(false);
