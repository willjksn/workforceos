...
Future schema changes get a new `0010_*.sql` (or later) file. Never modify `0000`–`0009` after they have been applied. `0009_swift_saracen.sql` is the notification-dedupe index. `0008_cooing_blade.sql` is the Phase 9 Scout and SkillBridge migration.
