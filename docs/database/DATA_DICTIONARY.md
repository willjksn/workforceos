...
| `roles` | Access bundles: job-shaped **templates** (e.g. Recruiter Standard) and **functional modules** (e.g. Finance, Military Talent). Not job titles. A person may hold many. Only `admin.roles` assigns them (DEC-AUTH-003). |
